...
import com.vaibhav.domain.PaymentMethod;
import com.vaibhav.model.*;

import com.vaibhav.repository.PaymentOrderRepository;
import com.vaibhav.response.PaymentLinkResponse;
...
public class OrderController {
    ...
    public ResponseEntity<Order> cancelOrder(
        ...
        report.setTotalOrders(report.getTotalOrders()+order.getTotalSellingPrice());
