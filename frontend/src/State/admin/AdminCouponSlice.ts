...
>("coupon/createCoupon", async ({ coupon, jwt }, { rejectWithValue }) => {
  try {
    ...
    console.error('Error creating coupon:', errorMessage, error);
...
>("coupon/deleteCoupon", async ({ id, jwt }, { rejectWithValue }) => {
  try {
    ...
    console.error('Error deleting coupon:', errorMessage, error);
    return rejectWithValue(errorMessage);
  }
});
...
>("coupon/fetchAllCoupons", async (jwt, { rejectWithValue }) => {
  try {
    ...
    console.error('Error fetching coupons:', errorMessage, error);
    return rejectWithValue(errorMessage);
  }
});
