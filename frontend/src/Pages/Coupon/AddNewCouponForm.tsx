...
import { Box, Button, Grid2, TextField, MenuItem } from '@mui/material'
  ...
  const formik=useFormik<CouponFormValues>({
    ...
    onSubmit:(values)=>{
      ...
      const formatedValues={
        ...values,
        vaildityStartDate:values.validityStartDate?.toISOString(),
        validityEndDate:values.validityEndDate?.toISOString(),
        accountType: values.accountType
      }
      console.log("form submited", values,formatedValues)
      // TODO: Submit formatedValues to the backend API
    }
  })
  return (
    <div>
      <h1 className='tsxt-2xl font-bold text-primary-color pb-5 text-center'></h1>
        ...
        <Box component={"form"} onSubmit={formik.handleSubmit}sx={{mt:3}}>
          ...
          <Grid2 size={{xs:12 , sm:6}}>
            <TextField
              ...
              helperText="Choose who can use this coupon"
            >
